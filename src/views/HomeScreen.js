  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Category />
        <TouchableOpacity onPress={() => navigation.navigate("TopToursScreen")}>
          <Text
            style={{
              fontWeight: "bold",
              color: COLORS.primary,
        ...
        <Category2 />
        <TouchableOpacity onPress={() => navigation.navigate("Caronboardscreen")}>
          <Text
            style={{
              fontWeight: "bold",
              color: COLORS.primary,
        ...
        <Category3 />
        <TouchableOpacity onPress={() => navigation.navigate("BudgetEstimateBoard")}>
          <Text
            style={{
              fontWeight: "bold",
              color: COLORS.primary,
